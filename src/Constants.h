...
public:
    ...
    void Init()
    {
        ...
        m_StringTable[i++].Init( "STR_CRITICAL_HIT_EFF", STR_CRITICAL_HIT_EFF );
        ...
        m_StringTable[i++].Init( "STR_EXCELLENT_HIT", STR_EXCELLENT_HIT );
        ...
        m_StringTable[i++].Init( "STR_MON_DISAPPEARS", STR_MON_DISAPPEARS );
        ...
        m_StringTable[i++].Init( "STR_ONE_WAY_DOOR", STR_ONE_WAY_DOOR );
        m_StringTable[i++].Init( "STR_FOUND_SECRET_DOOR", STR_FOUND_SECRET_DOOR );
        m_StringTable[i++].Init( "STR_LIGHT_FLOOD", STR_LIGHT_FLOOD );
        ...
        m_StringTable[i++].Init( "STR_SEE_ITEM_TARGET", STR_SEE_ITEM_TARGET );
        m_StringTable[i++].Init( "STR_SEE_ITEM", STR_SEE_ITEM );
        ...
        m_StringTable[i++].Init( "STR_TOOK_OFF", STR_TOOK_OFF );
        m_StringTable[i++].Init( "STR_CANT_REMOVE", STR_CANT_REMOVE );
        m_StringTable[i++].Init( "STR_WELDED", STR_WELDED );
        ...
        m_StringTable[i++].Init( "STR_DROPPED_N", STR_DROPPED_N );
        ...
        m_StringTable[i++].Init( "STR_SCROLL_SLIPS", STR_SCROLL_SLIPS );
        m_StringTable[i++].Init( "STR_YOU_DRANK", STR_YOU_DRANK );
        m_StringTable[i++].Init( "STR_YOU_DRANK_N", STR_YOU_DRANK_N );
        ...
        m_StringTable[i++].Init( "STR_WAND_EXPLODES", STR_WAND_EXPLODES );
        m_StringTable[i++].Init( "STR_WAND_GLOWS", STR_WAND_GLOWS );
        m_StringTable[i++].Init( "STR_GLOWS_POWER", STR_GLOWS_POWER );
        m_StringTable[i++].Init( "STR_GLOWS_SOFT", STR_GLOWS_SOFT );
        m_StringTable[i++].Init( "STR_AREA_REVEALED", STR_AREA_REVEALED );
        m_StringTable[i++].Init( "STR_DUNGEON_REVEALED", STR_DUNGEON_REVEALED );
        ...
        m_StringTable[i++].Init( "STR_BRIEF_SHIMMER", STR_BRIEF_SHIMMER );
        m_StringTable[i++].Init( "STR_WRENCHING", STR_WRENCHING );
        m_StringTable[i++].Init( "STR_RECALL_ACTIVE", STR_RECALL_ACTIVE );
        m_StringTable[i++].Init( "STR_RECALL_DRIFT", STR_RECALL_DRIFT );
        m_StringTable[i++].Init( "STR_RECALL_RESET", STR_RECALL_RESET );
        m_StringTable[i++].Init( "STR_RECALL_TO_TOWN", STR_RECALL_TO_TOWN );
        m_StringTable[i++].Init( "STR_RECALL_TO_DEPTH", STR_RECALL_TO_DEPTH );
        m_StringTable[i++].Init( "STR_NOW_CURSED", STR_NOW_CURSED );
        m_StringTable[i++].Init( "STR_NO_LONGER_CURSED", STR_NO_LONGER_CURSED );
        m_StringTable[i++].Init( "STR_IMMUNE", STR_IMMUNE );
        m_StringTable[i++].Init( "STR_RESIST", STR_RESIST );
        m_StringTable[i++].Init( "STR_WELCOME_LEVEL", STR_WELCOME_LEVEL );
        m_StringTable[i++].Init( "STR_FEEL_AMAZING", STR_FEEL_AMAZING );
        m_StringTable[i++].Init( "STR_FEEL_LOT_BETTER", STR_FEEL_LOT_BETTER );
        m_StringTable[i++].Init( "STR_FEEL_BETTER", STR_FEEL_BETTER );
        m_StringTable[i++].Init( "STR_FEEL_BIT_BETTER", STR_FEEL_BIT_BETTER );
        m_StringTable[i++].Init( "STR_FEEL_PROTECTED", STR_FEEL_PROTECTED );
        m_StringTable[i++].Init( "STR_LESS_PROTECTED", STR_LESS_PROTECTED );
        m_StringTable[i++].Init( "STR_COMPLETELY_HEALTHY", STR_COMPLETELY_HEALTHY );
        m_StringTable[i++].Init( "STR_RES_FEAR", STR_RES_FEAR );
        m_StringTable[i++].Init( "STR_YOU_AFRAID", STR_YOU_AFRAID );
        m_StringTable[i++].Init( "STR_YOU_BLIND", STR_YOU_BLIND );
        m_StringTable[i++].Init( "STR_YOU_CONFUSED", STR_YOU_CONFUSED );
        m_StringTable[i++].Init( "STR_RES_POISON", STR_RES_POISON );
        m_StringTable[i++].Init( "STR_YOU_POISONED", STR_YOU_POISONED );
        m_StringTable[i++].Init( "STR_YOU_CANT_MOVE", STR_YOU_CANT_MOVE );
        m_StringTable[i++].Init( "STR_FALL_ASLEEP", STR_FALL_ASLEEP );
        m_StringTable[i++].Init( "STR_EYES_TINGLY", STR_EYES_TINGLY );
        m_StringTable[i++].Init( "STR_SENSE_THOUGHTS", STR_SENSE_THOUGHTS );
        ...
        m_StringTable[i++].Init( "STR_FADE_FROM_VIEW", STR_FADE_FROM_VIEW );
        m_StringTable[i++].Init( "STR_LIGHT_FEET", STR_LIGHT_FEET );
        m_StringTable[i++].Init( "STR_FREE_TO_MOVE", STR_FREE_TO_MOVE );
        m_StringTable[i++].Init( "STR_MOVING_FASTER", STR_MOVING_FASTER );
        m_StringTable[i++].Init( "STR_NO_LONGER_AFRAID", STR_NO_LONGER_AFRAID );
        m_StringTable[i++].Init( "STR_CAN_SEE", STR_CAN_SEE );
        m_StringTable[i++].Init( "STR_CAN_THINK", STR_CAN_THINK );
        m_StringTable[i++].Init( "STR_NOT_POISONED", STR_NOT_POISONED );
        m_StringTable[i++].Init( "STR_CAN_MOVE_AGAIN", STR_CAN_MOVE_AGAIN );
        m_StringTable[i++].Init( "STR_WAKE_UP", STR_WAKE_UP );
        m_StringTable[i++].Init( "STR_NO_LONGER_RES_FEAR", STR_NO_LONGER_RES_FEAR );
        m_StringTable[i++].Init( "STR_NO_LONGER_RES_POISON", STR_NO_LONGER_RES_POISON );
        m_StringTable[i++].Init( "STR_EYES_STOP", STR_EYES_STOP );
        m_StringTable[i++].Init( "STR_NO_SENSE_THOUGHTS", STR_NO_SENSE_THOUGHTS );
        m_StringTable[i++].Init( "STR_NO_RES_FIRE", STR_NO_RES_FIRE );
        m_StringTable[i++].Init( "STR_NO_RES_COLD", STR_NO_RES_COLD );
        m_StringTable[i++].Init( "STR_NO_RES_ELEC", STR_NO_RES_ELEC );
        m_StringTable[i++].Init( "STR_NO_RES_ACID", STR_NO_RES_ACID );
        m_StringTable[i++].Init( "STR_REAPPEAR", STR_REAPPEAR );
        m_StringTable[i++].Init( "STR_FLOAT_DOWN", STR_FLOAT_DOWN );
        m_StringTable[i++].Init( "STR_SLUGGISH", STR_SLUGGISH );
        m_StringTable[i++].Init( "STR_SLOWING_DOWN", STR_SLOWING_DOWN );
        m_StringTable[i++].Init( "STR_MORE_EXPERIENCED", STR_MORE_EXPERIENCED );
        m_StringTable[i++].Init( "STR_LESS_EXPERIENCED", STR_LESS_EXPERIENCED );
        m_StringTable[i++].Init( "STR_WEAKENED", STR_WEAKENED );
        m_StringTable[i++].Init( "STR_INV_QUAFF", STR_INV_QUAFF );
        m_StringTable[i++].Init( "STR_INV_READ", STR_INV_READ );
        m_StringTable[i++].Init( "STR_INV_WIELD", STR_INV_WIELD );
        m_StringTable[i++].Init( "STR_INV_ZAP", STR_INV_ZAP );
        m_StringTable[i++].Init( "STR_INV_FIRE_AMMO", STR_INV_FIRE_AMMO );
        m_StringTable[i++].Init( "STR_INV_USE_STAFF", STR_INV_USE_STAFF );
        ...
        m_StringTable[i++].Init( "STR_INV_FIRE_WEAPON", STR_INV_FIRE_WEAPON );
        m_StringTable[i++].Init( "STR_INV_WEARING", STR_INV_WEARING );
        m_StringTable[i++].Init( "STR_ZAP_PROMPT", STR_ZAP_PROMPT );
        m_StringTable[i++].Init( "STR_CHOOSE_AMMO", STR_CHOOSE_AMMO );
        m_StringTable[i++].Init( "STR_CHOOSE_INV", STR_CHOOSE_INV );
        m_StringTable[i++].Init( "STR_CHOOSE_INV_SPACE", STR_CHOOSE_INV_SPACE );
        m_StringTable[i++].Init( "STR_CHOOSE_EQUIP", STR_CHOOSE_EQUIP );
        m_StringTable[i++].Init( "STR_CHOOSE_TARGET_DIR", STR_CHOOSE_TARGET_DIR );
        ...
        m_StringTable[i++].Init( "STR_WIZ_LABEL", STR_WIZ_LABEL );
